...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/28 20:32:57 by iaktas            #+#    #+#             */
/*   Updated: 2025/08/28 20:32:58 by iaktas           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	process_file_in_order(t_shell *shell, t_command *cmd,
	char *filename)
{
	int	append_mode;
...
static int	setup_command_fds(t_shell *shell, t_command *cmd)
{
	int	i;
